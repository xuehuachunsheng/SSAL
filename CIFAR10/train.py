...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/strain_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR10/{}-{}/test_acc.csv".format(args.info, args.balance)
