...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/sup/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/sup/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/sup/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/sup/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/sup/best_model.pth".format(args.info, args.balance)
...
n_classes = SVHNDataset.C # total class number
