...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/strain_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/SVHN/{}-{}/best_model.pth".format(args.info, args.balance)
...
# The 1st convolution layer for SVHN is 7x7
# model = unsupresnet.ResNet(num_classes=n_classes, f_kernel_size=7)
