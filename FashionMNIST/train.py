...
n_classes = len(FashionMNISTDataset.classes_finest) # total class number

DEVICE = torch.device('cuda' if torch.cuda.is_available() else 'cpu')

train_loss_file = "/home/wyx/vscode_projects/SSAL/models/FashionMNIST/{}-{}/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/FashionMNIST/{}-{}/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/FashionMNIST/{}-{}/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/FashionMNIST/{}-{}/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/FashionMNIST/{}-{}/best_model.pth".format(args.info, args.balance)
...
for epoch in range(1, E1*E2 + 1):
    ...
    # 当epoch = E1*E2时，会进行选择，但不会再训练，这时选择的样本不计入labeled dataset
    # 这是因为E1设定为查询轮数+1。
    if epoch % E2 == 0:
        print("AL Beginning.....")
        # Load the best model
