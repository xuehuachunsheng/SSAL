...
train_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/{}-{}/sup/train_loss.csv".format(args.info, args.balance)
val_loss_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/{}-{}/sup/val_loss.csv".format(args.info, args.balance)
test_acc_file = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/{}-{}/sup/test_acc.csv".format(args.info, args.balance)
states_file_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/{}-{}/sup/states.json".format(args.info, args.balance)
best_model_path = "/home/wyx/vscode_projects/SSAL/models/CIFAR100/{}-{}/sup/best_model.pth".format(args.info, args.balance)
...
n_classes = CIFAR100Dataset.C # total class number
